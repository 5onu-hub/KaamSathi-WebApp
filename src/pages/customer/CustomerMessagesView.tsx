...
import { MessageSquare, Search, ShieldCheck, Clock, CheckCheck, ChevronRight, Filter } from "lucide-react";
...
export function CustomerMessagesView() {
  ...
  const filtered = conversations.filter(c => {
    ...
    if (filterTab === "unread") return matchesSearch && (c.unreadCount?.cust_1 > 0);
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <img src={worker.avatar || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150"} alt={worker.name} className="w-14 h-14 rounded-full object-cover border-2 border-emerald-500 shadow-xs" />
