...
import { MessageSquare, Search, ShieldCheck, ChevronRight } from "lucide-react";
...
export function WorkerMessagesView() {
  ...
  useEffect(() => {
    axios.get("/api/v1/messages?role=worker")
      .then(res => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black text-gray-900">Worker Partner Messages</h2>
          <p className="text-xs text-gray-500">Secure real-time customer communications & dispatches</p>
        </div>
